...
aarhus_mun <- municipalities_25832[municipalities_25832$NAME_2=="Århus",]
#%>% filter(NAME_2 == "Århus")

# Plot the aarhus municipality and the shelters
plot(st_geometry(aarhus_mun), col = "grey", border = "white")
plot(st_geometry(shelters), add = TRUE, pch = 16, col = "forestgreen")

# Compute the coordinates of the bounding box
st_bbox(aarhus_mun)

# Create a bounding box polygon
aarhus_box <- st_make_grid(st_bbox(aarhus_mun), n = 1)
...
all.equal(crs(shelters),crs(aarhus_mun))
